...
exports.metaChecks = [
    (0, factory_1.createCheck)({
        ...
        technicalExplanation: 'The <title> is the strongest on-page relevance signal and the clickable headline in search results. A page with no title element cannot communicate its topic to search engines.',
        ...
        evaluate(a) {
            ...
            return (0, factory_1.passed)('Title tag is present.');
        },
    }),
    (0, factory_1.createCheck)({
        id: 'meta.title.empty',
        ...
        technicalExplanation: 'An empty title is equivalent to a missing one for ranking and SERP display; search engines fall back to guessing a title from page content.',
        ...
        evaluate(a) {
            ...
            return (0, factory_1.passed)('Title tag has content.');
        },
    }),
    (0, factory_1.createCheck)({
        ...
        technicalExplanation: 'Google truncates titles at roughly 600px (~60 characters). Overlong titles lose their tail keywords and calls-to-action in the SERP.',
        ...
        evaluate(a) {
            ...
            return (0, factory_1.passed)('Title length is within range.');
        },
    }),
    (0, factory_1.createCheck)({
        ...
        technicalExplanation: 'Very short titles rarely contain enough context or keywords to compete for relevant queries and waste available SERP real estate.',
    ...
    (0, factory_1.createCheck)({
        ...
        technicalExplanation: 'The meta description is the primary source for the SERP snippet. Without it, search engines auto-generate a snippet from page text, which is often less compelling and reduces click-through rate.',
        ...
        evaluate(a) {
            ...
            return (0, factory_1.passed)('Meta description is present.');
        },
    }),
    (0, factory_1.createCheck)({
        ...
        technicalExplanation: 'Descriptions beyond ~160 characters are truncated with an ellipsis in the SERP, cutting off information and any call to action.',
        ...
        evaluate(a) {
            ...
            return (0, factory_1.passed)('Meta description length is within range.');
        },
    }),
    (0, factory_1.createCheck)({
        ...
        technicalExplanation: 'Short descriptions under-utilize the snippet space and often fail to summarize the page or entice a click.',
        suggestedFix: `Expand the meta description to at least ${DESCRIPTION_MIN} characters.`,
        evaluate(a) {
            if (a.metaDescription !== null &&
    ...
    (0, factory_1.createCheck)({
        ...
        technicalExplanation: 'Without a canonical, search engines may index duplicate or parameterized variants of the URL separately, splitting ranking signals.',
        ...
        evaluate(a) {
            ...
            return (0, factory_1.passed)('Canonical link is present.');
        },
    }),
    (0, factory_1.createCheck)({
        ...
        technicalExplanation: 'Conflicting canonical tags are ambiguous; Google typically ignores all of them, forfeiting canonicalization control entirely.',
        ...
        evaluate(a) {
            ...
            return (0, factory_1.passed)('At most one canonical link is present.');
        },
    }),
    (0, factory_1.createCheck)({
        ...
        technicalExplanation: 'Pointing the canonical at an http:// URL can cause search engines to prefer the insecure variant for indexing, undermining an HTTPS migration.',
        suggestedFix: 'Update the canonical URL to use https://.',
        evaluate(a) {
            const insecure = a.canonicals.filter((c) => c.startsWith('http://'));
            if (insecure.length > 0) {
                return insecure.map((c) => ({
                    status: 'fail',
                    message: `Canonical points to an insecure URL: ${c}`,
                    affectedElement: c,
                }));
            }
            return (0, factory_1.passed)('Canonical URLs use HTTPS.');
        },
    }),
    (0, factory_1.createCheck)({
        ...
        technicalExplanation: 'A cross-domain canonical instructs search engines to attribute this page to another site, which — if unintentional — deindexes the page in favor of the external URL.',
        suggestedFix: 'Point the canonical at a URL on the same domain unless cross-domain consolidation is intended.',
        evaluate(a) {
            const pageDomain = (0, util_1.urlRegistrableDomain)(a.finalUrl);
            if (pageDomain === null) {
                return (0, factory_1.passed)('Page domain could not be determined; check skipped.');
            }
            const crossDomain = a.canonicals.filter((c) => {
                const domain = (0, util_1.urlRegistrableDomain)(c);
                return domain !== null && domain !== pageDomain;
            });
            if (crossDomain.length > 0) {
                return crossDomain.map((c) => ({
                    status: 'fail',
                    message: `Canonical points to another domain: ${c}`,
                    affectedElement: c,
                }));
            }
            return (0, factory_1.passed)('Canonical URLs are same-domain.');
        },
    }),
    (0, factory_1.createCheck)({
        ...
        technicalExplanation: 'A noindex directive (via meta robots or the X-Robots-Tag header) removes the page from search indexes entirely. This is critical when unintended.',
        ...
        evaluate(a) {
            ...
            return (0, factory_1.passed)('Page is indexable.');
        },
    }),
    (0, factory_1.createCheck)({
        ...
        technicalExplanation: 'A page-level nofollow stops crawlers from following any outgoing link, which can strand internal pages and waste crawl equity.',
        ...
        evaluate(a) {
            ...
            return (0, factory_1.passed)('Page-level links are followable.');
        },
    }),
    (0, factory_1.createCheck)({
        ...
        technicalExplanation: 'Contradictory directives (e.g. both index and noindex, or a meta index conflicting with an X-Robots-Tag noindex) are resolved unpredictably; the most restrictive usually wins, risking accidental deindexing.',
        suggestedFix: 'Reconcile robots directives so meta and header agree on a single intent.',
        evaluate(a) {
            const tokens = (0, util_1.robotsTokens)(a.robotsMeta.raw);
            ...
            return (0, factory_1.passed)('Robots directives are consistent.');
        },
    }),
    (0, factory_1.createCheck)({
        ...
        technicalExplanation: 'Without a declared charset the browser guesses the encoding, which can mangle multibyte characters and lets some XSS vectors through. Declare it early in <head>.',
        ...
        evaluate(a) {
            ...
            return (0, factory_1.passed)(`Charset declared: ${a.charset}.`);
        },
    }),
    (0, factory_1.createCheck)({
        ...
        technicalExplanation: 'Without a viewport meta, mobile browsers render at a desktop width and zoom out, failing Google mobile-friendliness and hurting mobile-first ranking.',
        ...
        evaluate(a) {
            ...
            return (0, factory_1.passed)('Viewport meta tag is present.');
        },
    }),
    (0, factory_1.createCheck)({
        ...
        technicalExplanation: 'A viewport without width=device-width (or one locking user-scalable/maximum-scale) prevents the layout from adapting to the device and blocks pinch-zoom, harming mobile usability.',
        suggestedFix: 'Set the viewport content to include width=device-width, initial-scale=1.',
        evaluate(a) {
            if (a.viewport === null) {
                return (0, factory_1.passed)('No viewport present; handled by meta.viewport.missing.');
            }
            const value = a.viewport.toLowerCase();
            const responsive = /width\s*=\s*device-width/.test(value);
            const locked = /user-scalable\s*=\s*no/.test(value) || /maximum-scale\s*=\s*1(\.0)?\b/.test(value);
            ...
            return (0, factory_1.passed)('Viewport is responsive.');
        },
    }),
    (0, factory_1.createCheck)({
        ...
        technicalExplanation: 'The lang attribute declares the page language for search engines, screen readers, and translation tools. Its absence weakens language targeting and accessibility.',
        suggestedFix: 'Add a lang attribute to <html>, e.g. <html lang="en">.',
        evaluate(a) {
            if (a.htmlLang === null) {
                return [{ status: 'fail', message: 'No lang attribute on <html>.' }];
            }
            return (0, factory_1.passed)(`HTML lang declared: ${a.htmlLang}.`);
        },
    }),
    (0, factory_1.createCheck)({
        ...
        technicalExplanation: 'Malformed language tags (e.g. "english" or "en_US") are ignored by user agents, negating language targeting and accessibility benefits.',
        suggestedFix: 'Use a valid BCP-47 tag such as "en", "en-US", or "zh-Hans-CN".',
        evaluate(a) {
            if (a.htmlLang !== null && !(0, util_1.isValidBcp47)(a.htmlLang)) {
                return [
                    {
                        status: 'fail',
            ...
            return (0, factory_1.passed)('HTML lang is a valid BCP-47 tag or absent.');
        },
    }),
];
