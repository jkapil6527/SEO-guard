...
exports.imageChecks = [
    (0, factory_1.createCheck)({
        ...
        technicalExplanation: 'Images without an alt attribute are invisible to screen readers and give search engines no textual context, forfeiting image-search relevance and accessibility.',
        suggestedFix: 'Add a descriptive alt attribute to each content image (alt="" only for decorative images).',
        evaluate(a) {
            ...
            return (0, factory_1.passed)('All images have an alt attribute.');
        },
    }),
    (0, factory_1.createCheck)({
        ...
        technicalExplanation: 'alt="" marks an image as decorative and hides it from assistive tech. When applied to a meaningful image it hides real content from screen readers and search engines.',
        suggestedFix: 'Provide descriptive alt text for meaningful images; keep alt="" only for purely decorative ones.',
        evaluate(a) {
            const empty = a.images.filter((img) => img.alt !== null && img.alt.trim().length === 0);
            if (empty.length > 0) {
                return empty.map((img) => ({
                    status: 'warning',
            ...
            return (0, factory_1.passed)('No images declare empty alt text.');
        },
    }),
    (0, factory_1.createCheck)({
        ...
        technicalExplanation: 'Explicit width lets the browser reserve layout space before the image loads, preventing cumulative layout shift (CLS), a Core Web Vitals factor.',
        ...
        evaluate(a) {
            ...
            return (0, factory_1.passed)('All images declare a width.');
        },
    }),
    (0, factory_1.createCheck)({
        ...
        technicalExplanation: 'Explicit height lets the browser reserve layout space before the image loads, preventing cumulative layout shift (CLS), a Core Web Vitals factor.',
        ...
        evaluate(a) {
            ...
            return (0, factory_1.passed)('All images declare a height.');
        },
    }),
    (0, factory_1.createCheck)({
        ...
        technicalExplanation: 'A broken image source degrades the user experience and signals poor maintenance; broken media can also affect image-search indexing.',
        ...
        evaluate(a, site) {
            ...
            return (0, factory_1.passed)('All checked image sources resolve successfully.');
        },
    }),
];
