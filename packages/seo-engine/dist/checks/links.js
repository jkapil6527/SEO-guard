...
exports.linkChecks = exports.MAX_REDIRECT_HOPS = void 0;
...
exports.linkChecks = [
    (0, factory_1.createCheck)({
        ...
        technicalExplanation: 'Broken internal links waste crawl budget, strand PageRank, and send users to dead ends. Internal 404s are entirely within the site owner control.',
        suggestedFix: 'Update or remove links that target error pages; add redirects for moved content.',
        evaluate(a, site) {
            ...
            return broken.length > 0 ? broken : (0, factory_1.passed)('All checked internal links resolve.');
        },
    }),
    (0, factory_1.createCheck)({
        ...
        technicalExplanation: 'Broken outbound links harm user trust and content quality signals, even though the target is outside the site owner control.',
        ...
        evaluate(a, site) {
            ...
            return broken.length > 0 ? broken : (0, factory_1.passed)('All checked external links resolve.');
        },
    }),
    (0, factory_1.createCheck)({
        ...
        weight: 10,
        description: `One or more links pass through more than ${exports.MAX_REDIRECT_HOPS} redirect hops.`,
        technicalExplanation: 'Long redirect chains slow page loads, dilute link equity at each hop, and risk exceeding crawler redirect limits, leaving the final target unindexed.',
        ...
        evaluate(a, site) {
            ...
            for (const link of a.links) {
                const status = statuses.get(link.href);
                if (status !== undefined && status.redirectHops > exports.MAX_REDIRECT_HOPS) {
                    long.push({
                        status: 'fail',
            ...
            return long.length > 0 ? long : (0, factory_1.passed)('No link exceeds the redirect-hop limit.');
        },
    }),
    (0, factory_1.createCheck)({
        ...
        technicalExplanation: 'A target="_blank" link without noopener lets the opened page access window.opener and navigate the original tab (reverse tabnabbing), a security and UX risk.',
        ...
        evaluate(a) {
            ...
            return (0, factory_1.passed)('All new-tab links use noopener/noreferrer.');
        },
    }),
    (0, factory_1.createCheck)({
        ...
        technicalExplanation: 'Anchor text is a relevance signal for the target page and a navigation aid for screen readers. Empty or generic anchors ("click here") convey no context.',
        ...
        evaluate(a) {
            ...
            if (offenders.length > 0) {
                return offenders.map((link) => ({
                    status: 'warning',
                    message: link.text.trim().length === 0
            ...
            return (0, factory_1.passed)('All links use descriptive anchor text.');
        },
    }),
];
