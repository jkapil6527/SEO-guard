...
exports.socialChecks = [
    (0, factory_1.createCheck)({
        ...
        technicalExplanation: 'Open Graph tags (og:title, og:type, og:image, og:url) control how the page renders when shared on social platforms. Missing tags produce broken or blank link previews, reducing referral click-through.',
        ...
        evaluate(a) {
            ...
            const missing = REQUIRED_OG.filter((key) => !(key in a.ogTags) || a.ogTags[key] === undefined || a.ogTags[key] === '');
            ...
            if (!hasAnyOg) {
                return [
                    {
                        status: 'fail',
                        message: 'No Open Graph tags found; required tags (og:title/type/image/url) are missing.',
                        metadata: { missing: REQUIRED_OG, present },
                    },
                ];
            }
            return (0, factory_1.passed)('All required Open Graph tags are present.');
        },
    }),
    (0, factory_1.createCheck)({
        ...
        technicalExplanation: 'Without twitter:card, X/Twitter falls back to a plain link with no rich preview, lowering engagement on shared URLs.',
        ...
        evaluate(a) {
            ...
            return (0, factory_1.passed)('Twitter Card type is declared.');
        },
    }),
];
